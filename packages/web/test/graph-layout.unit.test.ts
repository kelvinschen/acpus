...
function wideFanoutSwitchGraph(): WebGraph {
  return {
    ...
    nodes: [
      ...
      node({ id: "research_convergence", kind: "loop", parentId: "research_lane::branch%3Aconvergence", parentNodeId: "research_lane", path: ["root", "candidate_matrix", "do", "route_candidate", "case:0", "research_lane", "branch:convergence", "research_convergence"], detail: { kind: "loop", maxIterations: 20, stopWhen: "state.ready" } }),
...
function compositeGraph(): WebGraph {
  return {
    ...
    nodes: [
      ...
      node({ id: "repair_loop", kind: "loop", parentId: "lanes::do", parentNodeId: "lanes", path: ["root", "execution", "branch:lane_matrix", "lanes", "do", "repair_loop"], detail: { kind: "loop", maxIterations: 3, stopWhen: "state.done" } }),
