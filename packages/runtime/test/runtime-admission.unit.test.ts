...
import { preparedWorkflow, withRuntimeWorkspace } from "./support/runtime-fixtures.js";
...
describe("runtime admission normalization", () => {
  ...
  it("rejects self-consistent invalid frozen IR while allowing warning diagnostics", async () => {
    await withRuntimeWorkspace("runtime-admission-ir", async cwd => {
