...
| [CLI](cli-spec.md) | `acpus` | Command grammar and text/JSON presentation | [Compiler](workflow-compiler-spec.md), [Runtime](runtime-spec.md), [Hooks](hooks-spec.md) | `pnpm --filter acpus typecheck`, `pnpm test:e2e -- packages/cli`, `pnpm test:contract -- packages/cli` |
