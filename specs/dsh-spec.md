...
- The public `@acpus/dsh/remote` contribution MUST be generated by the supported
  Typert generator, mounted as unary Remote methods, and included with the
  Client bundle in the published package. It MUST expose these plain JSON DTOs
  and MUST NOT serialize `Result` values:
