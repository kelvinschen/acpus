...
- The WebUI MUST expose Runtime, Runs, and Workflows navigation.
...
- `@acpus/web` MUST expose reusable `WorkflowIR -> WebGraph` and self-contained HTML rendering helpers for CLI/static bundle generation.
